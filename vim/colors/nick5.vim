...
hi Statement term=bold ctermfg=DarkRed gui=NONE guifg=#ff6f00
hi PreProc term=underline ctermfg=Magenta guifg=#c0a080
hi Type term=underline ctermfg=Blue gui=NONE guifg=#ff6f00
