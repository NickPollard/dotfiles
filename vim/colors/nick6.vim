...
hi Special term=bold ctermfg=Magenta guifg=#a00000
hi Identifier term=underline ctermfg=Blue guifg=#A00000
hi Statement term=bold ctermfg=DarkRed gui=NONE guifg=#a00000
hi PreProc term=underline ctermfg=Magenta guifg=#a0a0f0
hi Type term=underline ctermfg=Blue gui=bold guifg=#a00000
hi Visual term=reverse ctermfg=Yellow ctermbg=Red gui=NONE guifg=White guibg=Gray15
hi Search term=reverse ctermfg=Black ctermbg=Cyan gui=NONE guifg=#f0a000 guibg=#ffffff 
